-- Ukrainian Translation Agent 3 - Database Update Script
-- Generated on: 2025-06-05
-- Target: Grants 178-203 (25 grants) + continuation grants 204-228 (25 grants)
-- Agent: Ukrainian Translation Agent 3

-- Begin transaction
BEGIN;

-- Agent 2's work completion (grants 178-203)
UPDATE grants SET
...
UPDATE grants SET
    ...
    eligibility_criteria_uk = 'CSOs in Central and Східна Європа including Україна',
    ...
    duration_uk = 'Multi-year',
    application_procedure_uk = 'Visit Mott Foundation грантs Database or contact foundation for Central and Східна Європа program заявкаs',
    additional_requirements_uk = 'Focus on громадянське суспільство, democratic foundations, and regional cooperation.',
    detailed_description_uk = 'Mott Foundation supports громадянське суспільство and democratic institutions in Central and Східна Європа. Check грантs Database for current opportunities.'
WHERE id = 188;
...
UPDATE grants SET
    ...
    grant_amount_uk = 'Project грантs',
    duration_uk = 'Varies',
    application_procedure_uk = 'Contact Robert Bosch Stiftung for Східна Європа program заявкаs and фінансування opportunities',
    additional_requirements_uk = 'Focus on Східна Європа initiatives and громадянське суспільство development.',
    detailed_description_uk = 'Robert Bosch Stiftung supports Східна Європа programs. Contact foundation for specific opportunities and заявка procedures.'
WHERE id = 189;
