  ...
  return (
    ...
    >
      ...
      <text x="600" y="555" textAnchor="middle" fontSize="16" fill={textColor}>
        💡 <tspan fontWeight="600">Key Insight:</tspan> Humanitarian response remains the top
...
export const TimelineInfographic = ({ darkMode }) => {
  ...
  const events = [
    ...
    },
    {
      ...
      detail: '₴500M raised by youth organizations',
      type: 'achievement',
    },
    {
      date: 'Jun 5',
    ...
    },
    {
      ...
      detail: '€450M channeled through civil society',
      type: 'success',
    },
    {
      date: 'Jun 30',
