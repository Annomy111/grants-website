        ...
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center">
            <Link to="/" className="flex items-center">
              <div className={`mr-3 w-10 h-10 flex items-center justify-center rounded-full ${darkMode ? 'bg-blue-700' : 'bg-blue-600'} text-white font-bold text-xl transition-colors duration-300`}>
                G
              </div>
              <span className={`text-xl font-bold ${darkMode ? 'text-white' : 'text-gray-800'} hidden md:block transition-colors duration-300`}>
                {t('appName')}
              </span>
            </Link>
          </div>
            ...
            <div className="relative ml-3 border-l border-gray-300 dark:border-gray-700 pl-3 flex items-center">
              <div className="flex items-center space-x-2">
                <button 
                  ...
                  className={`px-2 py-1 rounded text-sm transition-colors duration-200 ${language === 'en' 
                ...
                <button 
                  ...
                  className={`px-2 py-1 rounded text-sm transition-colors duration-200 ${language === 'uk' 
                    ? `${darkMode ? 'bg-gray-800 text-white font-bold' : 'bg-blue-100 text-blue-700 font-bold'}` 
                    : `${darkMode ? 'text-gray-300 hover:text-white' : 'text-gray-700 hover:text-blue-600'}`
                  }`}
                >
      ...
      >
        <div className={`px-2 pt-2 pb-3 space-y-1 ${darkMode ? 'bg-gray-900' : 'bg-white'}`}>
          ...
          <div className="flex items-center space-x-2 px-3 py-2 border-t border-gray-300 dark:border-gray-700 mt-2 pt-2">
            <span className={`text-sm ${darkMode ? 'text-gray-400' : 'text-gray-500'}`}>{t('languages')}</span>
            <button 
            ...
            <button 
              onClick={() => { changeLanguage('uk'); setMobileMenuOpen(false); }} 
              className={`px-2 py-1 rounded text-sm transition-colors duration-200 ${language === 'uk' 
                ? `${darkMode ? 'bg-gray-800 text-white font-bold' : 'bg-blue-100 text-blue-700 font-bold'}` 
                : `${darkMode ? 'text-gray-300 hover:text-white' : 'text-gray-700 hover:text-blue-600'}`
              }`}
