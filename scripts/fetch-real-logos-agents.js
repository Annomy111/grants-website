...
async function logoUrlIntelligenceAgent(organizations) {
  ...
  const cdnPatterns = {
    ...
    'entwicklung.at':
      'https://www.entwicklung.at/fileadmin/user_upload/Dokumente/Logos/ADA_Logo.svg',
    ...
    'gov.uk':
      'https://assets.publishing.service.gov.uk/government/uploads/system/uploads/organization/logo/uk-government-logo.png',
    ...
    'opensocietyfoundations.org':
      'https://www.opensocietyfoundations.org/themes/custom/osf/logo.svg',
  };
...
async function logoFetchingAgent(logoUrls) {
  ...
  for (const logoUrl of logoUrls.slice(0, 100)) {
    // Limit attempts
