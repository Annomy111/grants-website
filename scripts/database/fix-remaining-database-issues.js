...
const detailedDescriptions = {
  democracy:
    'This grant program focuses on strengthening democratic institutions, promoting civic participation, and supporting democratic governance. It aims to empower civil society organizations working on electoral processes, government accountability, transparency initiatives, and citizen engagement. The program supports projects that advance democratic values, human rights protection, and rule of law.',
  media:
    "This media support program provides funding for independent journalism, media literacy initiatives, and press freedom advocacy. It supports projects that strengthen media capacity, promote investigative journalism, combat disinformation, and protect journalists' rights. The program aims to build a robust and independent media ecosystem.",
  women:
    "This grant supports women's rights organizations and gender equality initiatives. It funds projects addressing gender-based violence, women's economic empowerment, political participation, and reproductive rights. The program prioritizes women-led organizations and initiatives that advance gender justice and equality.",
  youth:
    'This youth-focused grant program supports initiatives that empower young people, develop youth leadership, and promote youth civic engagement. It funds educational programs, skills development, youth entrepreneurship, and projects that address youth-specific challenges and opportunities.',
  humanitarian:
    'This humanitarian assistance program provides emergency support and crisis response funding. It supports organizations delivering essential services, protecting vulnerable populations, and building community resilience. The program focuses on immediate needs while promoting sustainable solutions.',
  'civil society':
    'This civil society support program strengthens the capacity of non-governmental organizations and community groups. It funds organizational development, advocacy initiatives, coalition building, and projects that enhance civic space and promote citizen participation in public affairs.',
  health:
    'This health-focused grant supports public health initiatives, healthcare access improvements, and health system strengthening. It funds projects addressing health disparities, disease prevention, mental health services, and community health education programs.',
  education:
    'This education grant program supports formal and informal education initiatives, skills training, and capacity building. It funds projects that improve educational access, quality, and relevance, with focus on marginalized communities and innovative educational approaches.',
  environment:
    'This environmental grant supports climate action, environmental protection, and sustainable development initiatives. It funds projects addressing climate change adaptation, biodiversity conservation, renewable energy, and environmental justice.',
  research:
    'This research grant supports policy research, data collection, and evidence-based advocacy. It funds studies that inform policy decisions, document human rights violations, analyze social trends, and generate knowledge for social change.',
  culture:
    'This cultural grant supports arts, heritage preservation, and creative expression initiatives. It funds projects that promote cultural diversity, artistic freedom, cultural exchange, and the use of arts for social transformation.',
  economic:
    'This economic development grant supports entrepreneurship, job creation, and economic empowerment initiatives. It funds projects that promote inclusive economic growth, support small businesses, and create economic opportunities for marginalized communities.',
};
...
const targetBeneficiaries = {
  democracy:
    'Civil society organizations, democracy activists, election monitors, government accountability groups, transparency advocates, civic education practitioners',
  media:
    'Independent journalists, media organizations, fact-checkers, media literacy trainers, journalism students, press freedom advocates',
  women:
    "Women's rights organizations, gender equality advocates, women entrepreneurs, survivors of gender-based violence, women in leadership",
  youth:
    'Youth organizations, student groups, young entrepreneurs, youth activists, educational institutions, youth service providers',
  humanitarian:
    'Internally displaced persons, refugees, conflict-affected communities, vulnerable populations, humanitarian organizations',
  'civil society':
    'Non-governmental organizations, community-based organizations, social movements, advocacy groups, civic coalitions',
  health:
    'Healthcare providers, community health workers, patient advocacy groups, public health organizations, mental health professionals',
  education:
    'Educational institutions, teachers, students, education advocates, training organizations, literacy programs',
  environment:
    'Environmental organizations, climate activists, conservation groups, sustainable development practitioners, affected communities',
  research:
    'Research institutions, think tanks, policy analysts, academic researchers, data scientists, evidence-based advocacy groups',
  culture:
    'Artists, cultural organizations, museums, heritage sites, creative industries, cultural practitioners, art educators',
  economic:
    'Small businesses, entrepreneurs, cooperatives, economic development organizations, vocational training providers',
};

// Reporting requirements based on grant size
const reportingRequirements = {
  micro:
    'Quarterly narrative reports, final financial report, impact stories, photos/videos of activities',
  small:
    'Quarterly progress reports, bi-annual financial reports, annual audit (if over €25,000), beneficiary data',
  medium:
    'Monthly progress reports, quarterly financial reports, annual external audit, detailed M&E data, case studies',
  large:
    'Monthly progress and financial reports, external evaluation, annual audit, comprehensive impact assessment, policy briefs',
  xlarge:
    'Bi-weekly progress updates, monthly comprehensive reports, quarterly external reviews, annual third-party evaluation, research publications',
};

// Application procedures
const applicationProcedures = {
  rolling:
    '1. Review eligibility criteria and guidelines\n2. Register on online portal\n3. Submit concept note (2-3 pages)\n4. Await initial review (2-4 weeks)\n5. If selected, submit full proposal\n6. Participate in due diligence process\n7. Contract negotiation and signing',
  deadline:
    '1. Check application deadline and prepare early\n2. Attend information session (if available)\n3. Develop full proposal with required documents\n4. Submit before deadline via online portal\n5. Await review decision (6-8 weeks)\n6. If selected, enter contracting phase\n7. Attend grantee orientation',
  twostage:
    '1. Submit Letter of Interest (LOI) during open window\n2. Initial screening and feedback (3-4 weeks)\n3. Invited applicants develop full proposal\n4. Submit detailed proposal with annexes\n5. Possible site visit or interview\n6. Final selection and notification\n7. Grant agreement and inception phase',
};
  ...
  try {
    ...
    for (const grant of grants) {
      ...
      if (!grant.description_en || grant.description_en.length < 100) {
        ...
        for (const [key, value] of Object.entries(detailedDescriptions)) {
          if (
            ...
            (grant.focus_areas_en && grant.focus_areas_en.toLowerCase().includes(key))
          ) {
            descKey = key;
            break;
          }
      ...
      if (!grant.additional_requirements && grant.type) {
        const requirements =
          additionalRequirements[grant.type] || additionalRequirements['Program'];
      ...
      if (!grant.language_requirements) {
        updates.language_requirements =
          'Applications accepted in English and Ukrainian. All supporting documents must be translated if in other languages.';
      ...
      if (!grant.contact_email) {
        const orgSlug =
          grant.funding_organization?.toLowerCase().replace(/[^a-z0-9]+/g, '-') || 'grants';
      ...
      if (!grant.keywords || grant.keywords?.length === 0) {
        ...
        const nameWords = grant.grant_name
          ...
          .split(/\s+/)
          .filter(
            word => word.length > 4 && !['grant', 'program', 'support', 'ukraine'].includes(word)
          );
        keywords.push(...nameWords);

        // Add keywords from focus areas
        if (grant.focus_areas_en) {
          const focusWords = grant.focus_areas_en
            .toLowerCase()
            .split(/[,\s]+/)
        ...
        if (grant.funding_organization) {
          ...
          if (grant.funding_organization.includes('Ministry'))
            keywords.push('government', 'bilateral');
          if (
            grant.funding_organization.includes('EU') ||
            grant.funding_organization.includes('European')
          )
            keywords.push('european', 'eu');
          if (grant.funding_organization.includes('UN'))
            keywords.push('united-nations', 'multilateral');
        }
    ...
    const { data: finalCheck } = await supabase
      .from('grants')
      .select(
        'id, grant_name, logo_url, deadline, status, description_en, target_beneficiaries, reporting_requirements'
      )
      .order('id');
    ...
    const stillMissing = {
      ...
      descriptions: finalCheck.filter(g => !g.description_en || g.description_en.length < 100)
        .length,
